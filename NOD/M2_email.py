...
# <!-- ======= Hero Section ======= -->
	...
	<div class="grid-child" data-aos="fade-up">
		...
		<div class="container">	
            ...
            <p style="font-size:16px; color: #913A1E"><br><br><b><u>NOTE:</b></u> <i>The results for your job will be stored on NOD server for <u>10 more days</u> after you have received the email.
            All result files will be automatically deleted after that. We recommend users to download the result tables in their local system as soon as the email is received.</i>
        </div>
        </div>
...
if inputSeqNo > 1:
    msg1="<b>ERROR</b>: <i>More than one sequences uploaded.</i>"
    msg2="""Mode-2 is a computationally intensive option, therefore it accepts <u>only a single sequence</u> in .fasta format<br> 
    Please check your input and try again.<br>If you wish to use multiple sequences, please start over with Mode-1.<br><br>
    """
...
#   msg2="It may take some time to find the approved drugs against your protein sequence.<br><br> An email containing <i><u>\"%s\"</i></u> in the subject<br>will be sent to <i><u>%s</u></i>.<br><br>Start Over to submit new queries." %(jobId,email)
    ...
    An e-mail with the given job title: <b><u>%s</u></b> in the subject will be sent to: <u>%s</u> <br>
    from: <u>nod.server.pushemail@gmail.com</u>.<br><br>
    """%(jobTitle,email)
    html_pg= html_pg+heroSec(msg1,msg2)
