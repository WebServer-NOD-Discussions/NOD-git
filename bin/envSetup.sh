...
#Variables_in_order:
#$1= mode,  $2= QueryFile, $3=complete Result_Dir, $4= JobId, $5=Job Title(original), $6= email ID, $7= actual resDir $8= qCoverage
...
python bin/master_handler_v2.py $1 $3/query.fasta $3 $8 &> $3/handler.log
echo -e "python bin/master_handler_v2.py $1 $3/query.fasta $3 $8 &> $3/handler.log\n\n"
